...
- Set up restricted shared VPCs with default DNS, NAT (optional), Private Service networking, on-premises Dedicated or Partner Interconnect, and baseline firewall rules for each environment.
